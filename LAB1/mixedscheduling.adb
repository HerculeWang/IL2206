...
procedure mixedscheduling is
   ...
   Start : Time; -- Start Time of the System
	Calibrator: constant Integer := 3400; -- Calibration for correct timing
 ...
 -- A higher number gives a higher priority
   end;
   ...
   Task_1 : T(1, 1, Warm_Up_Time, 100, 100, 10000); -- ID: 1
	                                                   -- Priority: 20
                                                      --	Phase: Warm_Up_Time (100)
	                                                   -- Period 2000, 
	                                                   -- Computation Time: 1000 (if correctly calibrated) 
	                                                   -- Relative Deadline: 2000
   Task_2 : T(2, 1, Warm_Up_Time, 100, 100, 10000);
   Task_3 : T(3, 1, Warm_Up_Time, 100, 100, 10000);
